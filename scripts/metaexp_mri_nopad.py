...
from test_mri_nopad import run_experiment
...
base_out_dir = "experiments/meta_mri_lin_nopad/"
...
for p in ParameterGrid(params_grid):
    ...
    ntp = p['ntp']
    n_layers = p['n_layers']
    out_dir = f"{base_out_dir}_h_{h_size}_z_{z_dim}_hid_{hidden}_ntp_{ntp}_l_{n_layers}/"
